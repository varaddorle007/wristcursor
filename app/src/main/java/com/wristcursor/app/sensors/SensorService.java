...
package com.wristcursor.app.sensors;
...
public class SensorService extends Service {
    ...
    private static final int DATA_RATE_LOW_US = 2500; // 400 Hz
    // 500 Hz. The HID link is paced at 125 Hz, so sampling faster than this only burns CPU and
    // battery running the EKF — it cannot make the pointer any fresher.
    private static final int DATA_RATE_HIGH_US = 2000;
     ...
     * @param reducedRate {@code true} if orientation events should be provided at 100 Hz, {@code
     *     false} for 200 Hz.
     */
