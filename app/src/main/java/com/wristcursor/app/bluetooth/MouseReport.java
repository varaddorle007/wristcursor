...
public class MouseReport {
    ...
    /**
     * Layout must match the HID report descriptor in {@link Constants} exactly:
     * [0] buttons, [1] X, [2] Y, [3] wheel — four bytes, all 8-bit.
     *
     * <p>Any change to this layout also changes the descriptor, and already-paired hosts keep the
     * old one; the mismatch silently routes movement into the wrong axis.
     */
    private final byte[] mouseData = new byte[4];
