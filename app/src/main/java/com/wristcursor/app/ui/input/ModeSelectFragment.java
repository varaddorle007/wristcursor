...
public class ModeSelectFragment extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Choosing a mode must remain possible while reconnecting. Closing this screen when the
        // HID link briefly drops made the new in-mouse mode button appear to do nothing.
