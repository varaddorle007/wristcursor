...
import com.wristcursor.app.ui.onboarding.OnboardingController;
...
public class InputSettingsFragment extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        initBooleanPref(SettingKey.GESTURE_PINCH);
        initBooleanPref(SettingKey.GESTURE_SHAKE_BACK);
        initBooleanPref(SettingKey.SHOW_CLICK_BUTTONS);

        findPreference("pref_settingControlMode")
