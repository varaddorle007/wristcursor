...
public class NotificationService extends Service {
    ...
    private static final String NOTIFICATION_CHANNEL_ID = "WristCursorNotif";
    private static final String NOTIFICATION_CHANNEL_NAME = "All notifications";
    private static final String ACTION_START = "com.wristcursor.app.START_NOTIF";
    private static final String EXTRA_DEVICE = "EXTRA_DEVICE";
    private static final String EXTRA_STATE = "EXTRA_STATE";
    private static final long STOP_GRACE_MS = 6000L;

    private boolean isForeground;
    private NotificationManager notificationManager;
    private HidDataSender hidDataSender;
    private final Handler mainHandler = new Handler(Looper.getMainLooper());
    private final Runnable stopWhenIdle =
            () -> {
                if (hidDataSender != null && hidDataSender.isConnectingOrConnected()) {
                    return;
                }
                Log.i(TAG, "Stopping FGS — idle");
                stopSelf();
            };
            ...
            new HidDataSender.ProfileListener() {
                ...
                public void onConnectionStateChanged(BluetoothDevice device, int state) {
                    if (state == BluetoothProfile.STATE_DISCONNECTED) {
                        // Bond→HID often blips DISCONNECTED. Keep FGS alive while retries run.
                        if (hidDataSender != null && hidDataSender.isConnectingOrConnected()) {
                            updateNotification(
                        ...
                        mainHandler.postDelayed(stopWhenIdle, STOP_GRACE_MS);
                        return;
                    }
                    mainHandler.removeCallbacks(stopWhenIdle);
                    String name = null;
